 ...
 * *****************************
 */
public final class AuroraInterNodeSentenceWordCountTopology {
    private AuroraInterNodeSentenceWordCountTopology() {
...
//        builder.setBolt("count", new WordCount(), 1).fieldsGrouping("split", new Fields("word"));
        ...
        conf.setMessageTimeoutSecs(30); // modified for latency
