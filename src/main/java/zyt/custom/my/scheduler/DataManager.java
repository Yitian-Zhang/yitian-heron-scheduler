...
public class DataManager {
    ...
    // this node - shoule get from config file, but set it here now
//    private String nodeName = "heron01";
//    private int capacity = 40; // percentage of cpu load: default = 60

    // 2018-05-22 modified ---------------------
    private String nodeName;
    private int capacity; // percentage of cpu load: default = 60
    // -----------------------------------------
    ...
    private DataManager() {
        ...
        try {
            ...
            clusterProperties.load(new FileInputStream("/home/yitian/heron-conf/db.ini"));
...
//            properties.load(new FileInputStream("D:\\Intellij Workspaces\\heron-java-streamlet-api-example-master\\src\\resources\\dbcp.properties"));
            properties.load(new FileInputStream("/home/yitian/heronIdea/heron-java-streamlet-api-example-master/src/resources/dbcp.properties"));
    ...
    /**
     * Stroe traffic of a pair of task to DB
...
//    }
     ...
     * ********************************
     * Add: 2018-05-17
     * calculate hot edgs in topology
     * Update: 2018-07-01
...
//            double bias = pair.getTraffic() - averageTraffic;
    ...
    /**
     * **************************************
     * add 2018-05-21 for hot edge schedule
     * **************************************
     * @return
     * @throws SQLException
     */
